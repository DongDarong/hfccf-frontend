...
<template>
  ...
  <div v-else class="space-y-4">
    <div class="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
      <div class="space-y-1">
        <h3 class="text-sm font-semibold text-slate-900">{{ t('preschoolReportSnapshots.labels.studentReportTitle') }}</h3>
        <p class="text-sm text-slate-500">{{ t('preschoolReportSnapshots.labels.studentReportSubtitle') }}</p>
      </div>
