...
.preschool-dashboard-spotlight__title {
  margin: 0.45rem 0 0;
  font-size: 1.4rem;
  font-weight: 800;
  color: #0f172a;
...
.preschool-dashboard-spotlight__text {
  margin: 0.75rem 0 0;
  font-size: 0.96rem;
  line-height: 1.7;
  color: #334155;
