...
import TournamentBanner from '@/modules/users/roles/sport-admin/components/admin-dashboard/TournamentBanner.vue'
import TournamentQuickPanels from '@/modules/users/roles/sport-admin/components/admin-dashboard/TournamentQuickPanels.vue'
