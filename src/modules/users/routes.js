...
import AddAdminPage from '@/modules/users/roles/super-admin/pages/AddAdmin.vue'
import ManageAdminsPage from '@/modules/users/roles/super-admin/pages/ManageAdmins.vue'
import PreschoolAdminDashboard from '@/modules/users/roles/preschool-admin/pages/Dashboard.vue'
import PreschoolStudentManagement from '@/modules/users/roles/preschool-admin/pages/StudentManagement.vue'
import ScholarshipAdminDashboard from '@/modules/users/roles/scholarship-admin/pages/Dashboard.vue'
import ScholarshipApplicationsPage from '@/modules/users/roles/scholarship-admin/pages/ScholarshipApplications.vue'
import EnglishAdminDashboard from '@/modules/users/roles/english-admin/pages/Dashboard.vue'
import EnglishTeacherManagement from '@/modules/users/roles/english-admin/pages/TeacherManagement.vue'
import SportAdminDashboard from '@/modules/users/roles/sport-admin/pages/Dashboard.vue'
import SportCoachManagement from '@/modules/users/roles/sport-admin/pages/CoachManagement.vue'
import EnglishTeacherDashboard from '@/modules/users/roles/english-teacher/pages/Dashboard.vue'
