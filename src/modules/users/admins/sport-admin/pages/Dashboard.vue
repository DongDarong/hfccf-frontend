...
import TournamentBanner from '@/modules/users/admins/sport-admin/components/admin-dashboard/TournamentBanner.vue'
import TournamentQuickPanels from '@/modules/users/admins/sport-admin/components/admin-dashboard/TournamentQuickPanels.vue'
