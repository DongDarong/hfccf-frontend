...
export default {
  preschoolReportsShared: {
    ...
    reportCard: {
      institutionName: 'HFCCF Preschool',
      ...
      dateRange: 'Period Dates',
      notAvailable: '—',
      attendanceTitle: 'Attendance Summary',
      categoryTitle: 'Performance by Learning Area',
      observationsTitle: 'Teacher Observations',
      emptyCategories: 'No category data available for this period.',
      emptyObservations: 'No teacher observations recorded for this period.',
      assessedBy: 'by',
      generatedAt: 'Generated',
      officialRecord: 'This is an official institutional record.',
