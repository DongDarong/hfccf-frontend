export default {
  preschoolEnrollmentPage: {
    ...
    applicationDialog: {
      ...
      sectionDescriptions: {
        student: 'Capture the student identity, birth location, and current residence details.',
      },
      subsections: {
      ...
      fields: {
        ...
        guardianRelationship: 'Guardian Type',
        guardianType: 'Guardian Type',
        guardianTypeOther: 'Other Guardian Type',
      ...
      placeholders: {
        firstName: 'Enter given name',
        lastName: 'Enter family name',
        givenName: 'Enter given name',
        familyName: 'Enter family name',
        khmerName: 'Enter Latin name',
        latinName: 'Enter Latin name',
        placeOfBirth: 'Place of Birth',
        loadingLocations: 'Loading locations…',
        noLocationOptions: 'No location options available',
        ...
        selectGuardianType: 'Select guardian type',
        guardianTypeOther: 'Enter guardian type, e.g. Aunt, Uncle',
      ...
      legacy: {
        birthPlaceLabel: 'Legacy birthplace',
        birthPlaceValue: 'Legacy place of birth retained: {value}',
        currentResidenceLabel: 'Legacy current residence',
        currentResidenceValue: 'Legacy current residence retained: {value}',
      },
    },
    ...
    validation: {
      ...
      guardianTypeRequired: 'Please select a guardian type.',
      guardianTypeOtherRequired: 'Please specify the guardian type.',
      guardianLocationRequired: 'Guardian location is required.',
      guardianProvinceRequired: 'Province is required.',
      guardianDistrictRequired: 'District is required.',
      guardianCommuneRequired: 'Commune is required.',
      guardianVillageRequired: 'Village is required.',
