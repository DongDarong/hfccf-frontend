export default {
  breadcrumb: {
    ...
    healthDetail: 'Health Information',
    guardianContactLog: 'Guardian Contact Log',
    ...
    teacherScheduleDetails: 'Teacher Schedule Details',
    scholarshipApplications: 'Scholarship Applications',
    scholarshipAssignedApplications: 'Assigned Scholarship Applications',
    scholarshipStudents: 'Scholarship Students',
    scholarshipReviews: 'Reviews',
    englishTeacherDashboard: 'Teacher Workspace',
    scholarshipTeacherDashboard: 'Scholarship Teacher Dashboard',
    newForm: 'New Form',
    editForm: 'Edit Form',
